...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("1: Podaj ćwiartkę układu współrzędnych");
        Console.WriteLine("2: Sprawdź, czy można skonstruować trójkąt");
        Console.WriteLine("3: Wczytaj i analizuj PESEL");
    ...
    // Zadanie 1: Ćwiartka układu współrzędnych
    ...
    // Zadanie 2: Czy można skonstruować trójkąt
